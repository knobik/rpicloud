 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \romanzipp\QueueMonitor\Routes\QueueMonitorRoutes::queueMonitor()
         * @param array $options
         * @static 
         */ 
        public static function queueMonitor($options = [])
        {
                        return \Illuminate\Routing\Router::queueMonitor($options);
        }
